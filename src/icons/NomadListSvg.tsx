...
const NomadListSvg: SvgIconType = (props) => {
	return (
		<SvgIcon
			{...props}
		...
		>
			...
			/>
			<path
				d="M27.517 16.77l.344.214 8.602 5.802c.225.154.332.308.332.593l-.012 23.136-.332-.202-8.66-5.837c-.178-.12-.285-.237-.285-.475l.012-23.23z"
				fill="#ff4742"
			/>
		</SvgIcon>
	);
